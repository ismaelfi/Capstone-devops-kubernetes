...
spec:
  selector:
    app: hello-python-udacity-capstone
  ports:
  - protocol: "TCP"
    port: 8080
    targetPort: 8080
...
kind: Deployment
metadata:
  name: hello-python-udacity-capstone
spec:
  selector:
    matchLabels:
      app: hello-python-udacity-capstone
...
`kubectl describe services hello-python-udacity-capstone-service`

You should see output similar to this:

```bash
Name:                     hello-python-udacity-capstone-service
Namespace:                default
Labels:                   <none>
Annotations:              <none>
Selector:                 app=hello-python-udacity-capstone
Type:                     LoadBalancer
IP Families:              <none>
IP:                       10.101.140.123
IPs:                      <none>
...
To cleanup the deployment do the following: `kubectl delete deployment hello-python-udacity-capstone`
